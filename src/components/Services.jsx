  ...
  return (
    <section id="Services" className="services">
      ...
      <div className="content">
        ...
        <div data-aos="zoom-out" className="backend">
          <img src={front} alt="" srcSet="" />
          <h5>{t("services.leadership.title")}</h5>
          <div className="comments">
            <div>
              <p>{t("services.leadership.desc")}</p>
              <p>
                <b>{t("services.leadership.skills")}</b>
              </p>
            </div>
          </div>
        </div>
        <div data-aos="zoom-out" className="frontend">
          <img src={front} alt="" srcSet="" />
          <h5>{t("services.architecture.title")}</h5>
          <div className="comments">
            <div>
              <p>{t("services.architecture.desc")}</p>
              <p>
                <b>{t("services.architecture.tools")}</b>
              </p>
            </div>
          </div>
        </div>
